...
{
	/// <summary>
	/// A <see cref="RaTweenDynamic{TargetT, ValueT}"/> tween handles the logics of tweening the Color of a SpriteRenderer
...
namespace RaTweening
{
	...
	public static partial class RaTweenUtilExtensions
	{
		...
		/// <param name="duration">The duration of the tween in seconds</param>
		public static RaTweenColor TweenColor(this SpriteRenderer self, Color startColor, Color endColor, float duration)
		{
