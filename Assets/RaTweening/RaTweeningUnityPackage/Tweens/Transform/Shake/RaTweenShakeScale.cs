...
{
	/// <summary>
	/// A <see cref="RaTweenShakeBase{TargetT}"/> tween handles the logics of tweening the Shake of a Scale of a Transform
	/// > Note: <see cref="RaTweenUtilExtensions"/> for all extension methods
	/// </summary>
	[Serializable]
	public class RaTweenShakeScale : RaTweenShakeBase<Transform>
	{
		public RaTweenShakeScale()
			: base()
		{

		}
		public RaTweenShakeScale(Transform target, Vector3 shake, float duration, int vibrato = 10, float randomness = 90f)
			: base(target, shake, duration, vibrato, randomness)
		{
		}

		public RaTweenShakeScale(Transform target, float shake, float duration, int vibrato = 10, float randomness = 90f, bool ignoreZAxis = true)
...
namespace RaTweening
{
	...
	public static partial class RaTweenUtilExtensions
	{
		...
		public static RaTweenShakeScale TweenShakeScale(this Transform self, float shake, float duration, int vibrato = 10, float randomness = 90f, bool ignoreZAxis = true)
		{
			return new RaTweenShakeScale(self, shake, duration, vibrato, randomness, ignoreZAxis).Play();
		}
		...
		/// <param name="vibrato">This will cause a vibration within the shake, else it will be a linear shake/param>
		/// <param name="randomness">Adds a random offset to the shake (0 to 180). Setting it to 0 will shake along a single direction.</param>
		public static RaTweenShakeScale TweenShakeScale(this Transform self, Vector3 shake, float duration, int vibrato = 10, float randomness = 90f)
		{
			return new RaTweenShakeScale(self, shake, duration, vibrato, randomness).Play();
		}
	}
