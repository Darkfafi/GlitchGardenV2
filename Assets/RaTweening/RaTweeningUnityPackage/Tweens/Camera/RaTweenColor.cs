...
{
	/// <summary>
	/// A <see cref="RaTweenDynamic{TargetT, ValueT}"/> tween handles the logics of tweening the BackgroundColor of a Camera
	/// > Note: This can also be used for fading logics \n
	/// > Note: <see cref="RaTweenUtilExtensions"/> for all extension methods
	/// </summary>
	[Serializable]
	public class RaTweenColor : RaTweenDynamic<Camera, Color>
	{
		...
		public RaTweenColor(Camera target, Color startColor, Color endColor, float duration)
			: base(target, startColor, endColor, duration)
		{

		}

		public RaTweenColor(Camera target, Color endColor, float duration)
		...
		protected override void DynamicEvaluation(float normalizedValue, Camera target, Color start, Color end)
		{
			Color delta = end - start;
			target.backgroundColor = ApplyExcludeChannels(target.backgroundColor, start + (delta * normalizedValue), _excludeChannels);
		}

		protected override RaTweenDynamic<Camera, Color> DynamicClone()
		{
		...
		protected override Color ReadValue(Camera reference)
		{
			return reference.backgroundColor;
		}
...
namespace RaTweening
{
	...
	public static partial class RaTweenUtilExtensions
	{
		...
		public static RaTweenColor TweenColorR(this Camera self, float red, float duration)
		{
		...
		/// <param name="duration">The duration of the tween in seconds</param>
		public static RaTweenColor TweenColorG(this Camera self, float green, float duration)
		{
		...
		/// <param name="duration">The duration of the tween in seconds</param>
		public static RaTweenColor TweenColorB(this Camera self, float blue, float duration)
		{
		...
		/// <param name="duration">The duration of the tween in seconds</param>
		public static RaTweenColor TweenColorA(this Camera self, float alpha, float duration)
		{
		...
		/// <param name="duration">The duration of the tween in seconds</param>
		public static RaTweenColor TweenColor(this Camera self, Color color, float duration)
		{
		...
		/// <param name="duration">The duration of the tween in seconds</param>
		public static RaTweenColor TweenColor(this Camera self, Color startColor, Color endColor, float duration)
		{
